...
static char *loadfile(char *name,char *file);
char save_message(char *name,const char *sauv,Client sender);
...
static void send_message_to_group(Client *clients, Client sender, int actual, const char *receiver,const char *buffer, char from_server);
static void join_groupe(Client sender,const char *receiver,const char *buffer);
